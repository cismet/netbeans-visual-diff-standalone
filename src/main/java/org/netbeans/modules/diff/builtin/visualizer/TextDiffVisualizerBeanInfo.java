...
public class TextDiffVisualizerBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            final PropertyDescriptor contextMode = new PropertyDescriptor("contextMode", TextDiffVisualizer.class);
            ...
            final PropertyDescriptor contextNumLines = new PropertyDescriptor(
                    "contextNumLines",
                    TextDiffVisualizer.class);
            contextNumLines.setDisplayName(NbBundle.getMessage(
                    TextDiffVisualizerBeanInfo.class,
                    "PROP_contextNumLines"));
            contextNumLines.setShortDescription(NbBundle.getMessage(
                    TextDiffVisualizerBeanInfo.class,
                    "HINT_contextNumLines"));
