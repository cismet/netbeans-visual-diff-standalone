...
public class GraphicalDiffVisualizerBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            final PropertyDescriptor colorAdded = new PropertyDescriptor("colorAdded", GraphicalDiffVisualizer.class);
            colorAdded.setDisplayName(NbBundle.getMessage(GraphicalDiffVisualizerBeanInfo.class, "PROP_colorAdded"));
            colorAdded.setShortDescription(NbBundle.getMessage(
                    GraphicalDiffVisualizerBeanInfo.class,
                    "HINT_colorAdded"));
            final PropertyDescriptor colorMissing = new PropertyDescriptor(
                    "colorMissing",
                    GraphicalDiffVisualizer.class);
            colorMissing.setDisplayName(NbBundle.getMessage(
                    GraphicalDiffVisualizerBeanInfo.class,
                    "PROP_colorMissing"));
            colorMissing.setShortDescription(NbBundle.getMessage(
                    GraphicalDiffVisualizerBeanInfo.class,
                    "HINT_colorMissing"));
            final PropertyDescriptor colorChanged = new PropertyDescriptor(
                    "colorChanged",
                    GraphicalDiffVisualizer.class);
            colorChanged.setDisplayName(NbBundle.getMessage(
                    GraphicalDiffVisualizerBeanInfo.class,
                    "PROP_colorChanged"));
            colorChanged.setShortDescription(NbBundle.getMessage(
                    GraphicalDiffVisualizerBeanInfo.class,
                    "HINT_colorChanged"));
